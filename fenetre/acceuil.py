...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_2.setGeometry(QRect(230, 440, 151, 16))
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", u"CONNEXION", None))
        self.motP.setText(QCoreApplication.translate("Form", u"code", None))
        self.bouton.setText(QCoreApplication.translate("Form", u"CONNEXION", None))
        self.label_2.setText(QCoreApplication.translate("Form", u"code incorrect inexistant...", None))
    # retranslateUi
