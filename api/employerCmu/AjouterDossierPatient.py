...
from fenetre.Ea import Ui_Form
from api.conServer import client

class apple(QtWidgets.QWidget,Ui_Form):
    def __init__(self):
        super(apple,self).__init__()
        self.setupUi(self)
        self.setWindowTitle("Cree Dossier Patient")
        self.connecte()
    ...
    def ajouter(self):
        ...
        if self.e.text() == "oui":
            ...
            self.en = False
        client.service.ajouterDossier(self.isnn,self.n,self.p,self.ncm,self.ville,self.agee,self.ho,self.fe,self.en)
        self.nom.clear()
        self.prenom.clear()
        self.ncmu.clear()
        self.age.clear()
